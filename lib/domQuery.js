...
function query(selectorString,parent = document, limit = null){
...
//@reqParam('selectorString')
function queryOne(selectorString,parent = document){
  if(selectorString == null) throw new Error('No selectorString specified');
...
function _selectorHandlerSingular(selectorString){
  ...
  const selector = _selectorParser(selectorString,method);
...
function _genericSingular(selectorString, parent = document){
  return parent.querySelector(selectorString);
  
}

//for #idName queries
function _getById(selectorString,parent = document){
...
function _getByClass(selectorString, parent=document, limit = null){
